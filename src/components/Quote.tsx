    ...
    >
      ...
      <div className="container mx-auto px-6 sm:px-8 max-w-4xl text-center relative z-10">
        ...
        <div ref={decorRef} className="mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full shadow-lg">
        ...
        <p
          ref={quoteRef}
          className="text-xl sm:text-2xl md:text-3xl font-serif font-light text-slate-700 leading-relaxed mb-8 sm:mb-12 italic"
        >
          &ldquo;{quote}&rdquo;
        </p>
