            ...
            {mapEmbedUrl ? (
              ...
              <div className="w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
                <div className="text-center p-6">
                  ...
                  <h3 className="text-lg font-semibold text-blue-700 mb-2">{locationName}</h3>
                  <p className="text-sm text-blue-600 mb-4">{locationAddress}</p>
                  <p className="text-xs text-blue-500">Maps tidak tersedia</p>
                </div>
              </div>
            )}
          </div>
